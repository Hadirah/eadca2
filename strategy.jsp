...
<title>SP Gamestore-Strategy</title>
<!-- Bootstrap Core CSS -->
...
<%
	...
	<%
		...
		String genrename = request.getParameter("strategy");

		String sql = "Select game.gameid,title,image,price from game,game_genre,genre where game.gameid=game_genre.gameid and genre.genreid=game_genre.genreid and genrename like '%strategy%'";

		PreparedStatement pstmt = conn.prepareStatement(sql);


out.println("<br><br><h1>Strategy</h1>");
