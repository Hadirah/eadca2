...
%>
<form action="addcomment.jsp?value=<%=gameid%>" method="post">
<!-- <h3>GameID: <input type="text" name="gameid" required></h3> -->
			<h3>Commenter: <input type="text" name="commenter" required></h3>
		
		
			<h3>Rating: <input type="text" name="rating" required></h3>
		
		
			<h3>Date: <input type="text" name="date" required></h3>
		
	
			<h3>Comment: <input type="text" name="comment" required></h3>
