...
<%
	...
	<%
		...
		String genrename = request.getParameter("rpg");

		String sql = "Select game.gameid,title,image,price from game,game_genre,genre where game.gameid=game_genre.gameid and genre.genreid=game_genre.genreid and genrename like '%rpg%'";

		PreparedStatement pstmt = conn.prepareStatement(sql);

		
out.println("<br><br><h1>Rpg</h1>");
