...
<header>
	<div class="header-content">
		<div class="header-content-inner">
			<h1>Updating Genre in the process</h1>
<form action="updategen.jsp" method="post">

			<h3>GenreID: <input type="text" name="genreid" required></h3>
	<h3>Genre Name: <input type="text" name="genrename" required></h3>
